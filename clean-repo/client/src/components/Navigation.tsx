...
export default function Navigation({ onBookingClick }: NavigationProps) {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-[#555555]/95 backdrop-blur-sm border-b border-[#6b6b6b]">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-64 bg-[#777777] rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 border border-[#6b6b6b]">
                <div className="py-2">
                  {businessRegistrationServices.map((service) => (
                    <Link
                      key={service.slug}
                      href={service.isPage ? `/services/${service.slug}` : `/service/${service.slug}`}
                      className="block px-4 py-2 text-sm text-[#232323] hover:text-[#232323] hover:bg-[#777777]"
                    >
                      {service.name}
                    </Link>
                  ))}
            ...
            <Link 
              ...
              className="text-white hover:text-gray-200 px-3 py-2 text-sm font-medium flex items-center group"
            >
              <Brain className="mr-1 h-4 w-4 text-[#5b91e1] group-hover:text-white transition-colors" />
              AI Recommendations
            </Link>
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-2 w-[800px] bg-[#777777] rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 max-h-[80vh] overflow-y-auto border border-[#6b6b6b]">
                <div className="p-6">
